...
\end{itemize}
\begin{figure}[H]
\centering{\includegraphics[scale=0.5]{dataset/bounding_box}}
...
\begin{figure}[H]
\centering{\includegraphics[scale=0.4]{f1-score/whole}}
\caption{F1-score on whole system}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[scale=0.4]{f1-score/isolated}}
\caption{F1-score with isolated bounding box}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[scale=0.4]{f1-score/embedded}}
