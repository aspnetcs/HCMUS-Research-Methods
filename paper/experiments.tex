...
\end{itemize}
\begin{figure}[H]
\centering{\includegraphics[scale=0.5]{eps/boxes}}
...
%\newpage
\begin{figure}[H]
\centering{\includegraphics[scale=0.6]{eps/faster-1x.eps}}
\caption{Faster R-CNN with schedule 1x}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[scale=0.6]{eps/dynamic-1x.eps}}
\caption{Dynamic R-CNN with schedule 1x}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[scale=0.6]{eps/faster-2x.eps}}
\caption{Faster R-CNN with schedule 2x}
\end{figure}

The F1-score gained from the model is as follow.
\begin{figure}[H]
\centering{\includegraphics[scale=0.35]{eps/f1-whole.eps}}
\caption{F1-score on whole system}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[scale=0.35]{eps/f1-isolated.eps}}
\caption{F1-score with isolated bounding box}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[scale=0.35]{eps/f1-embedded.eps}}
